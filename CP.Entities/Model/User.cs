namespace CP.Entities.Model
{
    ...
    public partial class User : BaseEntity<int>
    {
        ...
        [RegularExpression(@"^[a-zA-ZçÇIiðÐþÞüÜöÖ]*$", ErrorMessage = "Ýsim sadece harflerden oluþmalýdýr.")]
        public string FirstName { get; set; }

        [StringLength(150)]
        [Display(Name = "Soyadý")]
        [Required(ErrorMessage = "Soyisim boþ býrakýlamaz.")]
        [RegularExpression(@"^[a-zA-ZçÇIiðÐþÞüÜöÖ]*$", ErrorMessage = "Soyisim sadece harflerden oluþmalýdýr.")]
