...
namespace CP.Mobile.TabbedPage.MenuItemTabbed
{
    ...
    public partial class Desserts : ContentPage
    {
        ...
        public void DessertsLoad()
        {
            pageModel = new MainPageModel(this, 9);
        ...
        private async void FlowListView_Refreshing(object sender, EventArgs e)
        {
            ...
            ListDesserts.IsRefreshing = true;
            ...
            ListDesserts.IsRefreshing = false;
        }
        ...
        private void DessertsSearch_TextChanged(object sender, TextChangedEventArgs e)
        {
            ListDesserts.FlowItemsSource = pageModel.Items.Where(x => x.Name.Contains(DessertsSearch.Text)).ToList();
        }
    }
}